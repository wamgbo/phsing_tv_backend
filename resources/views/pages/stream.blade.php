...
<body class="bg-surface text-on-background min-h-screen flex flex-col pb-10">
  ...
  <header class="sticky top-0 z-50 glass-nav border-b border-outline-variant/30 shadow-sm">
    <div class="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
      ...
      @if(session('user_id'))
            <div
          class="flex items-center gap-4 bg-surface-container-highest px-4 py-2.5 rounded-lg border
      ...
      class="bg-primary text-white font-medium px-6 py-2 rounded-full hover:bg-primary-hover transition-all
    ...
    <main class="flex-grow max-w-7xl mx-auto w-full p-6 lg:p-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div
          ...
          <div
            class="p-4 border-b border-outline-variant/20 flex items-center justify-between bg-surface-container-low">
